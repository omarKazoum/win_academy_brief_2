...
public class Constants {
    public static final int SCHOOL_CLASS_JAVA_ID=1;
    public static final int SCHOOL_CLASS_JS_ID=2;

    public static final int SUBJECT_JS_ID=1;
    public static final int SUBJECT_REACT_ID=2;
    public static final int SUBJECT_JAVA_ID=3;
    public static final int SUBJECT_ANGULAR_ID=4;

    public static final int ROLE_ADMIN_ID =1;
    public static final int ROLE_STUDENT_ID =2;
